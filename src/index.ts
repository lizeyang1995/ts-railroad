...
import { calculateNumberOfRouteWithMaximumDistance } from './CalculateNumberOfRoute/WithMaximumDistance/calculate';
...
const numberOfMethodsWithMaximumDistance = calculateNumberOfRouteWithMaximumDistance(30, "C", "C", 0)
